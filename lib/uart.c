...
LOCAL void _uart0_rx_isr(void *arg)
{
    uart_event_t e;
...
void ICACHE_FLASH_ATTR uart0_init(uart_param_t* param)
{
    ...
    _xt_isr_attach(ETS_UART_INUM, _uart0_rx_isr, 0);
...
void ICACHE_FLASH_ATTR uartx_putchar_dummy(char c)
{
    }
...
void ICACHE_FLASH_ATTR uart1_init(void)
{
    ...
    os_install_putc1((void *)uartx_putchar_dummy);
